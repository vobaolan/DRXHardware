...
export const ProductFormModal: React.FC<ProductFormModalProps> = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!coverImage.trim()) {
      showToast('Vui lòng nhập hoặc chọn ảnh đại diện!', 'error');
      return;
    }
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-4 bg-slate-50 dark:bg-slate-950/50 p-4 sm:p-5 rounded-2xl border border-slate-200 dark:border-slate-800">
            <h3 className="text-xs font-black uppercase text-[#0284c7] tracking-wider flex items-center gap-2">
              ...
              <span>2. Giá Bán & Quản Lý Kho</span>
            </h3>

            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              <div className="space-y-1.5">
                <label className="text-xs font-bold text-slate-700 dark:text-slate-300">
                  Giá Niêm Yết (Gốc) <span className="text-rose-500">*</span>
                </label>
                <input
                  type="number"
                  required
              ...
              <div className="space-y-1.5">
                ...
                <input
                  ...
                  className="w-full bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl px-3.5 py-2.5 text-xs font-mono font-bold text-emerald-600 dark:text-emerald-400 focus:border-[#0284c7] outline-none"
                />
              </div>
          ...
          {/* 3. HARDWARE IMAGES & REAL PHOTO PRESETS */}
          <div className="space-y-4 bg-slate-50 dark:bg-slate-950/50 p-4 sm:p-5 rounded-2xl border border-slate-200 dark:border-slate-800">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
              <h3 className="text-xs font-black uppercase text-[#0284c7] tracking-wider flex items-center gap-2">
                <ImageIcon className="w-4 h-4" />
                <span>3. Quản Lý Hình Ảnh Thực Tế Linh Kiện (Photo Gallery)</span>
              </h3>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-12 gap-4 items-center">
              <div className="sm:col-span-8 space-y-1.5">
                <label className="text-xs font-bold text-slate-700 dark:text-slate-300">
                  Link Ảnh Đại Diện Chính (Cover Image URL) <span className="text-rose-500">*</span>
                </label>
                <input
                  type="url"
                  required
                  ...
                  className="w-full bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl px-3.5 py-2.5 text-xs font-mono text-slate-900 dark:text-slate-100 focus:border-[#0284c7] outline-none"
                />
              </div>
              ...
              <div className="sm:col-span-4 flex items-center gap-3">
                ...
                <div className="text-[11px] text-slate-500">
                  <span className="font-bold text-slate-800 dark:text-slate-200 block">Xem trước ảnh bìa</span>
                  <span>Hiển thị trên trang chủ & danh mục</span>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-2 pt-2 border-t border-slate-200 dark:border-slate-800">
              ...
              <div className="flex gap-2">
                <input
                  type="url"
                  placeholder="Nhập thêm URL hình ảnh chi tiết khác..."
                ...
                <button
                  ...
                  className="px-3.5 py-2 rounded-xl bg-[#0284c7] hover:bg-[#0369a1] text-white text-xs font-bold transition-all flex items-center gap-1 cursor-pointer shrink-0"
                >
              ...
              {screenshots.length > 0 && (
                <div className="grid grid-cols-3 sm:grid-cols-6 gap-2.5 pt-2">
                  {screenshots.map((img, idx) => (
                    <div key={idx} className="group relative aspect-square rounded-xl overflow-hidden border border-slate-200 dark:border-slate-700 bg-slate-100 dark:bg-slate-800 shadow-2xs">
                      ...
                      {img === coverImage && (
                        <div className="absolute bottom-1 left-1 bg-[#0284c7] text-white text-[8px] font-black px-1.5 py-0.2 rounded">
                          BÌA
                        </div>
                      )}
                    </div>
