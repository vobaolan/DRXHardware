...
export const INITIAL_PRODUCTS: HardwareProduct[] = [
  ...
  },
  {
    ...
    category: "CASE",
    brand: "Lian Li",
    coverImage: "https://images.unsplash.com/photo-1618384887929-16ec33fab9ef?w=800&q=80",
    screenshots: ["https://images.unsplash.com/photo-1618384887929-16ec33fab9ef?w=800&q=80"],
    specs: {
