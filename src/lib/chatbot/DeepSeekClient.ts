  ...
  async generateChatCompletion(messages: any[], tools?: any[]) {
    try {
      ...
      if (userText.includes('liên hệ') || userText.includes('địa chỉ') || userText.includes('sđt') || userText.includes('hotline')) {
        return {
          role: 'assistant',
          content: '📍 **Thông Tin Liên Hệ DRX Hardware**:\n• Hotline kỹ thuật & tư vấn: **1900.88.99.77**\n• Email: `cskh@drxhardware.vn`\n• Showroom: **Showroom DRX Hardware, 128 Nguyễn Trãi, Q.1, TP. Hồ Chí Minh**\n• Giờ mở cửa: 08:00 - 21:30 (Tất cả các ngày trong tuần).'
        };
      }
