  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-[#090d16] text-slate-900 dark:text-slate-100 flex flex-col antialiased tech-grid-pattern transition-colors duration-300">
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-10 space-y-8">
        ...
        {/* 1. HERO BANNER TITLE */}
        <div className="relative rounded-3xl overflow-hidden border border-slate-200/90 dark:border-slate-800 bg-white/95 dark:bg-slate-900/95 p-6 sm:p-8 shadow-sm backdrop-blur-md">
          ...
          <div className="relative z-10 flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
            ...
            <div className="flex items-center gap-2 flex-wrap w-full md:w-auto">
              <button
                ...
                className="flex-1 md:flex-none px-4 py-3 rounded-2xl bg-amber-500 hover:bg-amber-600 disabled:opacity-50 text-white text-xs font-heading font-black uppercase tracking-wider transition-all shadow-sm flex items-center justify-center gap-1.5 cursor-pointer active:scale-95"
              >
                <Bookmark className="w-4 h-4" />
                <span>Lưu Vào Profile</span>
              </button>
              ...
              <button
                ...
                disabled={selectedItemsCount === 0}
                className="flex-1 md:flex-none px-4 py-3 rounded-2xl bg-[#0284c7] hover:bg-[#0369a1] disabled:opacity-50 text-white text-xs font-heading font-black uppercase tracking-wider transition-all shadow-sm flex items-center justify-center gap-1.5 cursor-pointer active:scale-95"
              >
